...
{
    public class KewlDownloadList : Panel
    {
        public KewlDownloadList()
        {
        ...
        public void Add(KewlDownload download)
        {
            Controls.Add(download);
        }

        #region Nested type: StackLayout
        ...
        private class StackLayout : LayoutEngine
        {
            ...
            {
                var stackPanel = container as KewlDownloadList;
                if (stackPanel == null)
                    return false;
